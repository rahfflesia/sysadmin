...
sudo printf "                              31          ; Serial" >> /etc/bind/"${dbFile}"
sudo printf "                              604800      ; Refresh" >> /etc/bind/"${dbFile}"
sudo printf "                              86400       ; Retry" >> /etc/bind/"${dbFile}"
sudo printf "                              2419200     ; Expire" >> /etc/bind/"${dbFile}"
sudo printf "                              604800 )    ; Negative Cache TTL" >> /etc/bind/"${dbFile}"
sudo printf ";"
